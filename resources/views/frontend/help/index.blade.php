            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="list-inline custom-breadcrumb">
                        <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="@@page-link">Help E Book</a></li>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 order-2 order-md-1">
                    <h2 class="section-title">E-Book Donation</h2>
                    <p>You can help advance Tangerang Regency by providing a new model for donating digital books. Together we are strong, turn on Literacy</p>
                    <p>Kamu dapat membantu memajukan kabupaten tangerang yaitu dengan cara memberikan sebuah model baru berdonasi buku digital. Dengan bersama kita kuat, hidupkan Literasi</p>
                    <a href="https://bit.ly/E_Book_Donation" class="btn btn-primary-outline">Send E-Book</a>
                </div>
                <div class="col-md-6 order-1 order-md-2 mb-4 mb-md-0">
                    <img class="img-fluid w-100" src="{{asset('public/frontend/images/about/ebook.jpg')}}" alt="about image">
                </div>
            </div>
        </div>
    </section>
