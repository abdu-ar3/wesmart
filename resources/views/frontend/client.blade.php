        ...
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                <div class="col-xl-4 col-lg-5 align-self-end">
                    ...
                    <img class="img-fluid w-100" src="{{asset('public/frontend/images/banner/anak.png')}}" alt="banner-feature">
                </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-12 order-1 order-md-2 mb-4 mb-md-0">
                <img class="img-fluid w-100" src="{{asset('public/frontend/images/about/baganftbm1.jpg')}}" alt="about image">
            </div>
